...
(function () {
  ...
  function setReactiveVisualState(active) {
    if (active) {
      if (clearVizTimeout) {
        clearTimeout(clearVizTimeout);
        clearVizTimeout = null;
      }
